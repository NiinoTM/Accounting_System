...
class AdjustReceivableWindow(QWidget):
    ...
    def adjust_receivable(self):
        ...
        try:
            ...
            if new_amount <= 0:  # Allow any positive amount
        ...
        transaction_type = self.selected_transaction['type'] # get the transaction type
