# ar_ap/register_asset_transfer_outflow.py
...
class RegisterAssetTransferOutflowWindow(QWidget):
    def __init__(self, main_window):
        super().__init__()
        self.main_window = main_window
        self.setWindowTitle("Register Asset Transfer (Outflow)")
    ...
    def init_ui(self):
        ...
        self.save_button.clicked.connect(self.register_outflow)
    ...
    def register_outflow(self):
        ...
        transaction_type = "Outflow"  # Always "Outflow" for this function

        # Default details if empty
        if not details:
            details = f"{debtor_name}: Outflow"
        ...
        try:
            with self.db_manager as db:
                ...
                db.cursor.execute(
                    ...
                    (date, details, ar_account_id, asset_id, amount, 'DEBTOR_CREDITOR')  # Use 'details'
                )
